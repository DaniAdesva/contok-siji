    ...
    <div class="col-lg-9">
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="thumbnail">
                            ...
                            <div style="border-top:1px solid #eee;margin-top:10px" class="caption">
                                ...
                                <i = class='fa fa-star' style="color: #FFD700;"></i>
                                <i = class='fa fa-star-o' style="color: #FFD700;"></i>
                                <i = class='fa fa-star-o' style="color: #FFD700;"></i> <?php 
                                }elseif ($bintang==4) {                          
                                ?>
                                <i = class='fa fa-star' style="color: #FFD700;"></i>
                                <i = class='fa fa-star' style="color: #FFD700;"></i>
                                ...
                                ?>
                                    <a style="width:80px" href="?page=detail&produk=<?php echo $data['id_barang']; ?>" class="btn btn-default" role="button"> Detail</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <a class="btn btn-default btn-block" href="?page=terbaru">Tampilkan Lainnya</a>
            </div>
        </div>
